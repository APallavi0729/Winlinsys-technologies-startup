 ...
 <div class="container">
  <div class="row">
    <div class="col-sm-4">
      ...
      <button class = "btn1"><a href="windows.php">Topics Covered </a></button>
      <button class="btn"><a style="color: white; text-decoration: none;" href="">exam</a></button> 
    </div>
    <div class="col-sm-4">
      <video width="320" height="240" autoplay muted>
      ...
      <button class = "btn1"><a href="linux.php">Topics Covered </a></button>
      <button class="btn"><a style="color: white; text-decoration: none;" href="">exam</a></button> 
    </div>
    <div class="col-sm-4">
      <video width="320" height="240" autoplay muted>
...
<button class = "btn1"><a href="services.php">Topics Covered </a></button>
<button class="btn"><a style="color: white; text-decoration: none;" href="">exam</a></button> 
</div>
  </div>
</div>
